...
<!-- Mirrored from dsathemes.com/html/r_eine_1.1/files/location.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Dec 2024 10:24:07 GMT -->
<head>
	...
	<body>
		...
		<div id="page" class="page">
	      					...
	      					<nav class="wsmenu clearfix">
	        					<ul class="wsmenu-list">
								    ...
								    <li class="nl-simple" aria-haspopup="true">
								    	<a href="booking.html" class="btn btn--black hover--tra-black last-link">Book Online</a>
								    </li> 
					...
					<div class="row">	
						<div class="col">
							<div class="page-title-txt">
								...
								<p>Enhance your natural beauty with our expert services</p>
							</div>	
						</div>
					</div>
				</div>	   <!-- End container --> 
			...
			<!-- TEXT CONTENT
			============================================= -->
			<section class="ct-09 content-section division">
							...
							<div class="left-column wow fadeInRight">
								...
								<div class="ct-09-txt">
									...
									<ul class="advantages ico-30 clearfix">
										...
										<li><p><a href="contact.html">Learm More</a></p></li>
										<li class="advantages-links-divider"><p><span class="flaticon-vertical-line"></span></p></li>
										<li><p><a href="booking.html">Book Now</a></p></li>
									</ul>
