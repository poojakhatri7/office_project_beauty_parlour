...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Jun 26, 2025 at 01:52 PM
...
(9, 'pooja khatri', 8707858421, 'pooja@gmail.com', 'Hazratganj', '1234', 1, 'upload-images/hair_06.jpg', '29AALC6789996', 98000024),
(12, 'kavya singh', 8707858427, 'kavya@gmail.com', ' Rajajipuram ', '1234', 2, 'upload-images/beauty_02.jpg', NULL, NULL),
(16, 'anvi', 8019858421, 'anvi@gmail.com', 'Hazratganj', '1234', 2, 'upload-images/team-9.jpg', NULL, NULL),
(21, 'kavya  Kapoor', 8907843126, 'kavya@gmail.com', ' RAJAJIPURAM', '12345', 2, 'upload-images/hair_02.jpg', NULL, NULL),
(22, 'Riddhi', 9236789234, 'Riddhi@gmail.com', ' RAJAJIPURAM', 'riddhi', 2, 'upload-images/hair_08.jpg', NULL, NULL);
...
(2, 'upload-images/hero-9.jpg', 'Skin care studio', 'View Menu', 'https://beautyparlour.edug.in/pprice?c_id=2'),
...
(69, 'pooja', 'Malhotra@gmail.com', 8907843117, ' RAJAJIPURAM', '2025-06-21', '19:04', 'Nail Art', 'any'),
...
(6, 'pooja', 8907843117, 'Malhotra@gmail.com', ' RAJAJIPURAM', '123', 'upload-images/team-9.jpg'),
...
(18, 'POOJA KHATRI', 8907843126, 'khatri@gmail.com', 'Hazratganj', '123', 'upload-images/hair_08.jpg'),
...
(39, 'pooja', 8707858421, 'pooja7@gmail.com', '29AALC6789996', '123', ''),
...
--
ALTER TABLE `all_services`
  MODIFY `a_id` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
...
--
ALTER TABLE `category_service`
  MODIFY `c_id` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=213;
...
--
ALTER TABLE `sub_category_service`
  MODIFY `s_id` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
...
--
ALTER TABLE `users`
  MODIFY `id` int(35) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
COMMIT;
