...
<!-- Mirrored from dsathemes.com/html/r_eine_1.1/files/gift-cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Dec 2024 10:23:53 GMT -->
<head>
	...
	<body>
		...
		<div id="page" class="page">
			...
			<!-- INNER PAGE HERO
			============================================= -->	
			<section id="gift-page" class="inner-page-hero division">
				<div class="container">	
					<div class="row">	
						<div class="col">
							<div class="page-hero-txt color--white">
								<h2>Gift Certificates</h2>	
								<p>Share your love with our gift vouchers!</p>
							</div>	
						</div>
					</div>
				</div>	   <!-- End container --> 
			...
			<!-- SERVICES-3
			============================================= -->
			<div id="services-3" class="py-8 services-section division">
				<div class="container">
			 		...
			 		<div class="row">
			 			<div class="col">
			 				<div class="more-btn">
								<a href="pricing-2.html" class="btn btn--tra-black hover--black">View Our Menu</a>
							</div>
						</div>
					</div>	
			...
			<!-- TEXT CONTENT
			============================================= -->
			<section class="shape--01 smoke--shape py-7 ct-01 content-section division">
				<div class="container">
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6 order-last order-lg-2">
							<div class="txt-block left-column wow fadeInRight">
								...
								<!-- Title -->	
								<h2 class="h2-md">Look more natural with Reine studio</h2>
									...
									<ul class="accordion">
										...
										<li class="accordion-item is-active">
											...
											<div class="accordion-panel">
									      		<p class="mb-0">Nemo ipsam magna volute placerat a turpis ipsum purus sapien 
										...
										<li class="accordion-item">
											...
											<!-- Text -->	
											<div class="accordion-panel">
									      		<p class="mb-0">Volute magna  nemo ipsam placerat turpis ipsum purus sapien 
			...
			<!-- GIFT CARDS-1
			============================================= -->
			<div id="gift-cards" class="pt-8 cards-section division">
				<div class="container">
					...
					<div class="row justify-content-center">	
						<div class="col-md-10 col-lg-8">
							<div class="section-title text-center mb-6">	
								...
								<!-- Title -->	
								<h2 class="h2-title">Surprise Your Loved Ones</h2>	
						...
						<div class="row row-cols-1 row-cols-lg-3">
							...
							<div class="col">
								<div id="gcard-1-1" class="gift-card wow fadeInUp">	
									...
									<!-- Title -->
									<h4 class="h4-md">Gift Voucher</h4>

									<!-- Price -->									
									<sup>$</sup>								
									<span>250</span>
									<p>The price per one user. One Card, Endless Nail Procedures Options</p>

									<!-- Button -->
									<a href="contact.html" class="btn btn--tra-black hover--black">Buy The Card</a>
					...
					</div>	<!-- END GIFT CARDS WRAPPER -->

	
				</div>  <!-- End container -->	
			</div>	<!-- END GIFT CARDS-1 -->
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6 order-first order-lg-2">
							<div class="right-column wow fadeInLeft">
								...
								<!-- Text -->	
								<p class="mb-0">Nemo ipsam egestas volute turpis varius ipsum egestas purus diam ligula 
									sapien ultrice sapien tempor aliquam tortor ipsum and augue turpis quaerat aliquet 
									congue and molestie magna in congue undo aliquet congue ultrices quaerat
								</p>
						...
						<div class="row">
							<div class="col">
								<div class="banner-1-txt text-center color--white">
									...
									<!-- Button -->	
									<a href="booking.html" class="btn btn--tra-white hover--white">Book an Appointment</a>
