...
<head>
	...
	<body>
		...
		<div id="page" class="page">
	      					...
	      					<nav class="wsmenu clearfix">
	        					<ul class="wsmenu-list">
								    ...
								    <li class="nl-simple" aria-haspopup="true">
								    	<a href="booking.html" class="btn btn--tra-white hover--white last-link">Book Online</a>
								    </li> 
					...
					<div class="row">	
						<div class="col">
							<div class="page-hero-txt color--white">
								...
								<p>ou have questions? We have answers.</p>
							</div>	
						</div>
					</div>
				</div>	   <!-- End container --> 
						...
						<div class="col-xl-11">
							<div class="questions-wrapper">
								...
								<div class="question row wow fadeInUp">
									...
									<!-- Question -->
									<div class="col-lg-6">
										<h5 class="h5-md">How do I schedule an appointment?</h5>
									</div>
									...
									<div class="col-lg-6">
										...
										<!-- Text -->
										<p>Congue augue sagittis egestas integer velna purus purus magna nec suscipit diam 
										   egestas magna an aliquam vitae egestas ipsum purus ligula justo and molestie donec
										</p>

										<!-- Text -->
										<p class="mb-0">Sagittis augue congue egestas integer velna purus purus magna nec 
										   suscipit diam egestas magna an aliquam vitae egestas ipsum purus ligula andjusto  
										   molestie donec
										</p>
								...
								<div class="question row wow fadeInUp">
									...
									<!-- Question -->
									<div class="col-lg-6">
										<h5 class="h5-md">Who should I choose as my stylist?</h5>
									</div>
									...
									<div class="col-lg-6">
										...
										<!-- Text -->
										<p class="mb-0">Sagittis congue augue egestas integer velna purus purus magna libero 
										   suscipit and egestas  magna aliquam ipsum vitae purus justo lacus ligula ipsum 
										   primis cubilia donec undo augue luctus vitae and egestas molestie donec libero sapien 
										   and dapibus congue tempor quisque
										</p>
								...
								<div class="question row wow fadeInUp">
									...
									<!-- Question -->
									<div class="col-lg-6">
										<h5 class="h5-md">If I need to cancel my appointment, what should I do?</h5>
									</div>
									...
									<div class="col-lg-6">
										...
										<ul class="simple-list">
											...
											<li class="list-item">
												<p>Aliquam vitae molestie quisque sapien undo vitae egestas egestas quaerat 
													aliquet a tortor vitae molestie aliquet 
												</p>
											</li>

											<li class="list-item">
												<p class="mb-0">Sagittis congue augue magna volutpat porta mauris purus
													egestas and ipsum purus justo quaerat augue cubilia
												</p>
											</li>
								...
								<div class="question row wow fadeInUp">
									...
									<!-- Question -->
									<div class="col-lg-6">
										<h5 class="h5-md">Do you take coupons, gift certificates, or gift cards?</h5>
									</div>
									...
									<div class="col-lg-6">
										...
										<!-- Text -->
										<p class="mb-0">Congue augue sagittis egestas integer velna purus purus magna and 
										   suscipit diam egestas magna an aliquam vitae egestas ipsum purus ligula justo and 
										   molestie donec
										</p>
								...
								<div class="question row wow fadeInUp">
									...
									<!-- Question -->
									<div class="col-lg-6">
										<h5 class="h5-md">What brand of products do you cary?</h5>
									</div>
									...
									<div class="col-lg-6">
										...
										<!-- Text -->
										<p>Sagittis congue augue egestas integer velna purus purus magna libero suscipit 
											egestas and cubilia primis gravida
										</p>
			 		...
			 		<div class="row">
			 			<div class="col">
			 				<div class="more-btn mt-4">
								<a href="contact.html" class="btn btn--tra-black hover--black">Still Have Question?</a>
							</div>
						</div>
					</div>	<!-- END BUTTON -->	
			...
			<!-- GALLERY-3
			============================================= -->		
			<section id="gallery-3" class="pt-8 gallery-section division">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-6 col-lg-3">
							<div class="footer-contacts">
								...
								<!-- Address -->
								<p>8721 M Central Avenue, <br > Los Angeles, CA 90036</p> 

								<!-- Phone -->
								<p class="footer-phone"><a href="tel:123456789">phone: +12 9 8765 4321</a></p>

								<!-- Email -->
								<p class="footer-email"><a href="mailto:yourdomain@mail.com">hello@yourdomain.com</a></p>
						...
						<div class="col-sm-10 col-md-7 col-lg-5">
							<div class="footer-form">
								...
								<!-- Title -->
								<h5 class="h5-md">Stay in the Know</h5>

								<!-- Text -->
								<p>Subscribe our mailing list and be the first to know about special deals!</p>
								...
								<form class="newsletter-form">
									...
									<div class="input-group">
										...
										<span class="input-group-btn ico-15">
											<button type="submit" class="btn btn--black hover--tra-black">Subscribe</button>
										</span>
									</div>
