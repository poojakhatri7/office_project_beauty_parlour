...
.gallery-item:hover .custom-hover-icon {
  opacity: 1;
}
...
<div style="display: flex;  gap: 20px; justify-content: left;">
  ...
  <div style="position: relative; width: 200px;">
    <a href="images/gallery/woman_08.jpg" class="glightbox" data-gallery="mygallery">
      <img src="images/gallery/woman_08.jpg" alt="Image 1" style="width: 100%; display: block;">
  ...
  <!-- Image 2 -->
  <div style="position: relative; width: 200px;">
    <a href="images/gallery/beauty_01.jpg" class="glightbox" data-gallery="mygallery" >
      <img src="images/gallery/beauty_01.jpg" alt="Image 2" style="width: 100%; display: block;">
	  <div class="custom-hover-icon">
      <i class="fas fa-eye"></i>
		 </div>
    </a>
  ...
  <!-- Image 3 -->
  <div style="position: relative; width: 200px;">
    <a href="images/gallery/woman_07.jpg" class="glightbox" data-gallery="mygallery" >
      <img src="images/gallery/woman_07.jpg" alt="Image 3" style="width: 100%; display: block;">
	    <div class="custom-hover-icon">
     <i class="fas fa-eye"></i>
		  </div>
    </a>
  ...
  <!-- Image 4 -->
  <div style="position: relative; width: 200px;">
    <a href="images/gallery/beauty_02.jpg" class="glightbox" data-gallery="mygallery" >
      <img src="images/gallery/beauty_02.jpg" alt="Image 4" style="width: 100%; display: block;">
	      <div class="custom-hover-icon">
     <i class="fas fa-eye"></i>
		  </div>
    </a>
  ...
  <!-- YouTube Video -->
  <div style="position: relative; width: 200px;">
    <a href="https://www.youtube.com/watch?v=SZEflIVnhH8" class="glightbox" data-gallery="mygallery" data-type="video" >
      <img src="images/gallery/video-thumbnail.jpg" alt="Video" style="width: 100%; display: block;">
	    <div class="custom-hover-icon">
      <i class="fas fa-eye"></i>
		 </div>
    </a>
